...
\textbf{\phantom{\copyright ~ 2017 }Instituto de Ciencias de la Construcción Eduardo Torroja (IETcc-CSIC)}\\[5pt]
\textbf{Autores}:\\[5pt]
...
\begin{Verbatim}[fontsize=\small]
	$ node cteepbd.js -c src/docs/ejemplos/ejemploJ1_base.csv -l PENINSULA
\end{Verbatim}
%$
...
\begin{Verbatim}[fontsize=\small]
	$ node cteepbd.js -c src/docs/ejemplos/ejemploJ1_base.csv -l PENINSULA > balance.txt
\end{Verbatim}
%$
...
\VerbatimInput[fontsize=\small, frame=lines, rulecolor=\color{gray}]{./ejemplos/output/ejemploJ1_base.out}
...
\VerbatimInput[fontsize=\small, frame=lines, rulecolor=\color{gray}]{./ejemplos/output/ayuda.out}
...
\lstinputlisting{ejemplos/cte_test_carriers.csv}
...
\lstinputlisting[firstline=6, lastline=6,numbers=none]{ejemplos/cte_test_carriers.csv}

Para los componentes energéticos se definen los siguientes valores conocidos de metadatos:

\begin{itemize}
\item \texttt{CTE\_AREAREF}: área de referencia (superficie útil);
\item \texttt{CTE\_KEXP}; factor de exportación;
\item \texttt{CTE\_LOCALIZACION}: localización que define los factores de paso reglamentarios (\texttt{CANARIAS}, \texttt{CEUTAMELILLA}, \texttt{BALEARES}, \texttt{PENINSULA}).
\end{itemize}
...
\lstinputlisting{ejemplos/output/factorespen.csv}


Para los factores de paso se definen los siguientes valores conocidos de metadatos:

\begin{itemize}
\item \texttt{CTE\_FUENTE}: origen de los datos de factores de paso (\texttt{CTE2013});
\item \texttt{CTE\_FUENTE\_COMENTARIO}; información original sobre la fuente de datos;
\item \texttt{CTE\_LOCALIZACION}: localización que define los factores de paso reglamentarios (\texttt{CANARIAS}, \texttt{CEUTAMELILLA}, \texttt{BALEARES}, \texttt{PENINSULA}).
\end{itemize}
...
\lstinputlisting[firstline=1, lastline=1,numbers=none]{ejemplos/output/factorespen.csv}
...
\lstinputlisting[firstline=4, lastline=5,numbers=none]{ejemplos/output/factorespen.csv}
...
\lstinputlisting[language=]{ejemplos/output/balance.plain}
...
\lstinputlisting[language=XML]{ejemplos/output/balance.xml}
...
\lstinputlisting{ejemplos/output/balance.json}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemploJ1\_base.csv}}]{ejemplos/ejemploJ1_base.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ1\_base.out}}]{ejemplos/output/ejemploJ1_base.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemploJ2\_basePV.csv}}]{ejemplos/ejemploJ2_basePV.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ2\_basePV.out}}]{ejemplos/output/ejemploJ2_basePV.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemploJ3\_basePVexcess.csv}}]{ejemplos/ejemploJ3_basePVexcess.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ3\_basePVexcess.out}}]{ejemplos/output/ejemploJ3_basePVexcess.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemplos/ejemploJ5\_gasPV.csv}}]{ejemplos/ejemploJ5_gasPV.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ5\_gasPV.out}}]{ejemplos/output/ejemploJ5_gasPV.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemplos/ejemploJ6\_HPPV.csv}}]{ejemplos/ejemploJ6_HPPV.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ6\_HPPV.out}}]{ejemplos/output/ejemploJ6_HPPV.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemplos/ejemploJ7\_cogenfuelgasboiler.csv}}]{ejemplos/ejemploJ7_cogenfuelgasboiler.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ7\_cogenfuelgasboiler.out}}]{ejemplos/output/ejemploJ7_cogenfuelgasboiler.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemplos/ejemploJ8\_cogenbiogasboiler.csv}}]{ejemplos/ejemploJ8_cogenbiogasboiler.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ8\_cogenbiogasboiler.out}}]{ejemplos/output/ejemploJ8_cogenbiogasboiler.out}
...
\lstinputlisting[title={\textcolor{gray}{\footnotesize Componentes energéticos: ejemplos/ejemplos/ejemploJ9\_electr.csv}}]{ejemplos/ejemploJ9_electr.csv}

\lstinputlisting[language=, title={\textcolor{gray}{\footnotesize Resultados: ejemploJ9\_electr.out}}]{ejemplos/output/ejemploJ9_electr.out}
